...
static char *gen_dictionary_load(UDF_INIT *, UDF_ARGS *args, char *result,
...
udf_descriptor udf_gen_dictionary_load() {
  return {"gen_dictionary_load", Item_result::STRING_RESULT,
          reinterpret_cast<Udf_func_any>(gen_dictionary_load),
          gen_dictionary_load_init, gen_dictionary_load_deinit};
}
