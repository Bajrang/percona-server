...
static int data_masking_plugin_init(void *p)
{
  ...
  sql_print_information("DataMasking Plugin: Initializing data masking dictionary memory structures");
...
static int data_masking_plugin_deinit(void *p)
{
  ...
  sql_print_information("DataMasking Plugin: Deinitializing plugin memory structures");
